<style>
    #reship-form td{border-top: none;}
    .table-pay-order{margin-bottom: 0px;margin-top: -12px;}
</style>
<div class="row">
    <h3 class="header smaller lighter green">订单退货：<?php echo $order_id;?></h3>
</div>
<form action="?r=order/delivery/reshipcreate" method="post" id="reship-form">
    <table class="table table-pay-order">
        <tr>
            <td class="td-pay-order">
                ...
                <p>配送方式：
                    <select name="Reship[shipping_id]">
                        <option>&nbsp;</option>
                ...
                <p>物流公司：
                    <select name="Reship[logi_id]">
                        <?php foreach ($dlycorp_list as $v):?>
                        <option value="<?php echo $v['corp_id'];?>"><?php echo $v['name'];?></option>
                        <?php endforeach;?>
                    </select>
                </p>
                <p>物流费用：￥<input type="text" value="<?php echo $order_info['cost_freight'];?>" name="Reship[cost_freight]"></p>
            ...
            <td>
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>物流单号：<input type="text" value="" name="Reship[logi_no]"</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
    ...
    <table class="table table-pay-order">
        <tr>
            <td>
                <p>退货备注：</p>
                <textarea class="autosize-transition form-control" name="Reship[memo]" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 69px;"></textarea>
            </td>
        </tr>
    </table>
    <div class="clearfix form-actions">
        <div class="col-md-offset-3 col-md-9">
            <button class="btn btn-sm btn-success submit-reship" type="button">
