                    ...
                    <form class="form-horizontal form-addr" method="post" >
                        <div class="form-body">
                            <div class="form-group" id="area">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control input-sm" id="consigneePr">
                                        ...
                                        <?php foreach ($model['province'] as $v):?>
                                        <option value="<?php echo $v['region_id'];?>"><?php echo $v['local_name'];?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" placeholder="详细地址" id="consigneeAd" class="form-control input-sm" name="consigneeAd">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">邮编</label>
                                <div class="col-md-3">
                                    <input type="text" placeholder="邮编" id="consigneePD" class="form-control input-sm" name="consigneePD">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">收货人姓名</label>
                                <div class="col-md-3">
                                    <input type="text" placeholder="收货人姓名" id="consignee" class="form-control input-sm" name="consignee">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">手机</label>
                                <div class="col-md-3">
                                    <input type="text" placeholder="手机" id="consigneeNo" class="form-control input-sm" name="consigneeNo">
                                </div>
                            </div>
